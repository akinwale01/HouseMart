...
import rent from "../../data/rent.json"
              ...
              <SwiperSlide key={index} className="relative h-full w-full">
                <div className="flex flex-col text-center w-full h-full bg-black/50 justify-center items-center rounded-xl p-4 sm:p-6 md:p-8 lg:p-10">
                  ...
                  <p className="text-white/90 mt-2 sm:mt-4 max-w-full sm:max-w-2xl text-sm sm:text-base md:text-lg leading-[160%] tracking-[-0.02em]">
                    Find your perfect rental home from our wide selection of properties.
                  </p>
                </div>
              </SwiperSlide>
            ))}
        ...
        <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
          ...
          <div className="flex-1 flex flex-col gap-4 md:gap-6">
            ...
            <p className="text-[#333] text-left text-[15px] sm:text-[16px] md:text-[17px] leading-[170%] tracking-[-0.02em] max-w-full md:max-w-2xl">
              Renting a property with us means more than just finding a place to live, it’s about experiencing comfort, convenience, and peace of mind. Every rental comes with well-maintained, move-in ready spaces, transparent pricing, and responsive support whenever you need it. We take care of the details, from reliable maintenance and secure environments, to flexible lease options, so you can focus on living your best life. Whether you’re looking for a modern apartment, a family home, or a cozy studio, our properties are designed to suit your lifestyle and budget, making your rental journey simple, stress-free, and rewarding. <span className="text-[#dd6e06] font-bold">Check out what suits you from our options available.</span>
            </p>
          </div>
