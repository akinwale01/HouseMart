        ...
        <section className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
          ...
          <div className="flex-1 flex flex-col gap-4 md:gap-6">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold text-black leading-[140%] tracking-[-0.02em] text-left">
              Why Trust Us To Sell Your Property?
            </h2>
            <p className="text-[#333] text-left text-[15px] sm:text-[16px] md:text-[17px] leading-[170%] tracking-[-0.02em] max-w-full md:max-w-2xl">
              Unlock the true value of your property with us. Selling your home shouldn’t be stressful or uncertain—we make it simple, fast, and rewarding. Our team ensures every property is showcased at its best, attracts serious buyers, and achieves a competitive price. With transparent pricing, professional guidance, and unmatched support at every step, you can relax knowing your sale is in capable hands. From modern apartments to family homes and cozy studios, we turn your property into an opportunity, helping you sell smarter, faster, and with confidence. Join countless satisfied sellers who trust us to deliver results that exceed expectations. <Link href="/support"><span className="text-[#dd6e06] font-bold">Contact us today to get started!</span></Link>
            </p>
          </div>
