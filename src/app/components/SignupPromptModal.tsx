...
export default function SignupPromptModal({ onClose }: ModalProps) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
      <div className="bg-white rounded-2xl p-10 max-w-md w-full text-center shadow-lg">
        <h2 className="text-2xl font-bold mb-4">Signup Required</h2>
        <p className="text-gray-700 mb-6">
          Click the button below to create an account to with us today.
        </p>
