  ...
  const navGroups = [
    {
      ...
      links: [
        ...
        { icon: PlusCircle, label: "Add Property", href: "/dashboard/agent/add-property" },
        { icon: Calendar, label: "Appointments", href: "/dashboard/agent/appointments" },
      ],
    },
    {
      title: "Transactions",
      links: [
        { icon: FileText, label: "Transactions", href: "/dashboard/agent/transactions" },
        { icon: MessageSquare, label: "Messages", href: "/dashboard/agent/messages" },
        { icon: Star, label: "Reviews", href: "/dashboard/agent/reviews" },
      ],
    },
    {
      title: "Support",
      links: [
        { icon: HelpCircle, label: "Help Center", href: "/dashboard/agent/help" },
